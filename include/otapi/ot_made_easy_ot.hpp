...
public:
    ...
    OT_MADE_EASY_OT string create_pseudonym(const int nKeybits, const string & strNymIDSource, const string & strAltLocation);
    ...
    OT_MADE_EASY_OT string get_box_receipt(const string & SERVER_ID, const string & NYM_ID, const string & ACCT_ID, const int nBoxType, const string & STR_TRANS_NUM);
    ...
    OT_MADE_EASY_OT string get_payment_instrument(const string & SERVER_ID, const string & NYM_ID, const int nIndex);
    OT_MADE_EASY_OT string get_payment_instrument(const string & SERVER_ID, const string & NYM_ID, const int nIndex, const string & PRELOADED_INBOX); // PRELOADED_INBOX is optional.
    OT_MADE_EASY_OT bool insure_enough_nums(const int nNumberNeeded, const string & strMyServerID, const string & strMyNymID);
    ...
    OT_MADE_EASY_OT int retrieve_nym(const string & strServerID, const string & strMyNymID, bool & bWasMsgSent, const bool bForceDownload);
