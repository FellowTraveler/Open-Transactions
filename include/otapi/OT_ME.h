...
public:
    ...
    EXPORT  bool cancel_outgoing_payments (const std::string  & NYM_ID,
                                           ...
                                           const std::string  & INDICES);
    EXPORT  int32_t accept_from_paymentbox(const std::string  & ACCOUNT_ID, // This acct better have the right asset type, based on chosen indices.
                                           const std::string  & INDICES,
    ...
    EXPORT  std::string withdraw_cash(const std::string  & SERVER_ID,
                                      ...
                                      const std::string  & ACCT_ID,
                                      const int64_t   AMOUNT);
    EXPORT  int32_t easy_withdraw_cash(const std::string  & ACCT_ID,
                                       const int64_t        AMOUNT);
