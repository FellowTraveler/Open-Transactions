...
extern bool OT_COMMAND_OT details_show_credential(const string & strMyNymID, const string & strCredID);
...
extern bool OT_COMMAND_OT stat_partyagent(const string & strSmartContract, const string & strPartyName, const string & strAgentName, const int nIndex);
extern bool OT_COMMAND_OT stat_partyagent_index(const string & strSmartContract, const string & strPartyName, const int nCurrentAgent);
extern bool OT_COMMAND_OT stat_partyagents(const string & strSmartContract, const string & strPartyName, const int nDepth);
